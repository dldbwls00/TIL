...
public class FallingWordFrame extends JFrame {
	...
	private int score = 0;
	JLabel lb = new JLabel("score: "+score);
	...
	public FallingWordFrame() {
		...
		scorepanel = new scorepanel(gamePanel, controlPanel, score);
	...
	class scorepanel extends JPanel{
		...
		public scorepanel(GamePanel gamepanel, ControlPanel controlpanel, int score) {
